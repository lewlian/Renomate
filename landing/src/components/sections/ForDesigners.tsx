...
export function ForDesigners() {
  ...
  return (
    <section id="designers" className="bg-hint-sky py-24 md:py-32">
      <div className="container-page">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {benefits.map((b, i) => (
            <ScrollReveal key={b.title} delay={i * 0.1}>
              <div className="bg-canvas rounded-md p-6 h-full shadow-subtle">
                <h4 className="font-heading text-[22px] leading-tight text-deep-charcoal mb-3">{b.title}</h4>
        ...
        <ScrollReveal delay={0.3}>
          <div className="flex flex-wrap items-center gap-5">
            ...
            <p className="text-body-sm text-smoke max-w-[420px]">
